...
void Load::Update()
{
	...
	renderer.LoadTextrue("spacename.bmp",GS_TEXCOLOR_KEY_WHITE);//
	renderer.LoadTextrue("gs.bmp", GS_TEXCOLOR_KEY_WHITE);//
	renderer.LoadTextrue("gs_g.bmp", GS_TEXCOLOR_KEY_WHITE);//
	renderer.LoadTextrue("turt.bmp", GS_TEXCOLOR_KEY_WHITE);//
	renderer.LoadTextrue("turt_g.bmp", GS_TEXCOLOR_KEY_WHITE);//
